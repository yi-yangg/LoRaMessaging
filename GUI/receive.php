...
<head>
  ...
  <title>Receive | LoRa Project</title>
...
<body>
  ...
  <div class="container-fluid text-center pt-5 d-flex flex-column align-items-center">
    ...
    <p class="lead fs-2">Message Receiving Monitor</p>
    <div class="pt-5 d-flex flex-column w-50 align-items-center">
      <p class="mb-2 lead fs-4">Receiver COM Port: <span id="port-info" class="mt-2 text-danger">No port selected</span>
      </p>
      <div>
        <button type="button" id="select-button" class="btn btn-primary mb-2">Select Receiver Port</button>
        <button type="button" id="disconnect-button" class="btn btn-danger mb-2 d-none">Disconnect Receiver
          Port</button>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid text-center py-5 d-flex flex-column align-items-center d-none" id="monitor-container">
    <!-- Serial monitor -->
